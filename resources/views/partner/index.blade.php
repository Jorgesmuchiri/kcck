...
@extends('layouts.app', ['activePage' => 'partner', 'titlePage' => __('Partners')])
              ...
              <div class="card-body">
                ...
                <div class="row">
                  ...
                  <div class="col-12 text-right">
                    <a href="{{ route('event.create') }}" class="btn btn-sm btn-primary">{{ __('Add Partner') }}</a>
                  </div>
