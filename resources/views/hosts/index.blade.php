...
@extends('layouts.app', ['activePage' => 'hosts', 'titlePage' => __('Hosts')])
        ...
        <div class="col-md-12">
            <div class="card">
              <div class="card-header card-header-primary">
                <h4 class="card-title ">{{ __('Host') }}</h4>
              ...
              <div class="card-body">
                ...
                <div class="row">
                  ...
                  <div class="col-12 text-right">
                    <a href="{{ route('hosts.create') }}" class="btn btn-sm btn-primary">{{ __('Add Host') }}</a>
                  </div>
