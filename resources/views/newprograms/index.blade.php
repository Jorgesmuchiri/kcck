              ...
              <div class="card-body">
                ...
                <div class="row">
                  ...
                  <div class="col-12 text-right">
                    <a href="{{ route('newprograms.create') }}" class="btn btn-sm btn-primary">{{ __('Add Program') }}</a>
                  </div>
                        ...
                        <tr>
                         ...
                         {{ $job->course }}
                          ...
                          <td>
                            ...
                            @if ($job->id )
                              <form action="{{ route('newprograms.destroy', $job) }}" method="post">
                                  @csrf
                                  @method('delete')
