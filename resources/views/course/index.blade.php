...
@extends('layouts.app', ['activePage' => 'course', 'titlePage' => __('Programs')])
              ...
              <div class="card-body">
                ...
                <div class="row">
                  ...
                  <div class="col-12 text-right">
                    <a href="{{ route('course.create') }}" class="btn btn-sm btn-primary">{{ __('Add Program') }}</a>
                  </div>
                        ...
                        <tr>
                         ...
                         {{ $job->topic }}
                          ...
                          <td>
                            ...
                            @if ($job->id )
                              <form action="{{ route('course.destroy', $job) }}" method="post">
                                  @csrf
                                  @method('delete')
                              
                                  <a rel="tooltip" class="btn btn-success btn-link" href="{{ route('course.edit', $job->id) }}" data-original-title="" title="">
