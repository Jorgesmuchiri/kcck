...
<section class="teacher_section layout_padding-bottom">
      ...
      <div class="card-deck">
        <div class="card">
         ...
         <div class="card-body">
          ...
          <h5 class="main-heading ">Date: </h5><p class= "text-center">3rd - 7th February 2020</p>
          <h5 class="main-heading "> Venue:</h5><p class= "text-center">Strathmore University</p>
        </div>
      </div>
      <div class="card">
  ...
  Date:
        </h5><p class= "text-center">        27th - 31st January 2020</p>
        <h5 class="main-heading ">
          Venue:
        </h5><p class= "text-center">Strathmore University</p>
      </div>
   ...
   <h5 class="main-heading ">
      ...
      </h5><p class= "text-center">13th - 17th July 2020</p>
<h5 class="main-heading ">
        Venue:
      </h5><p class= "text-center">Nairobi</p>
  ...
  <h2 class="main-heading ">
      ...
      <h5 class="main-heading ">Date:
</h5><p class= "text-center">5th - 9th October 2020</p>

      <h5 class="main-heading ">Venue:
