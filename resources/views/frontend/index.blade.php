    ...
    <section class="hero_section ">
      <div class="hero-container container">
        ...
        <div class="hero_img-container">
          <div>
            <img src="images/code.png" alt="" class="img-fluid">
          </div>
        </div>
      </div>
    </section>
  ...
  <section class="about_section layout_padding">
    <div class="container">
      ...
      <div class="about_img-box ">
        <img src="images/African.png" alt="" class="img-fluid w-100">
      </div>
...
<section class="about_section layout_padding">
  ...
  <div class="column2">
    ...
    <h2>Be a Partner:</h2>
   <img src="images/business.png" height="250px">
     <p class="text-center">Join our endeavour of bringing up a generation of Kids who are innovative and confident.</p>
     <div class="text-center">
        <a href="partners" class="call_to-btn  ">
...
<div class="text-center">
  ...
  <div class="column2" >
    <h2>Be a Host: </h2>
      <img src="images/school.png" height="250px">
    <p class="text-center">Join us by hosting a coding club in your locality.
</p>
<div class="text-center">
        <a href="host" class="call_to-btn  ">
...
<section class="about_section layout_padding">
  ...
  <div class="column2">
    <h2>Our Courses</h2>
   <img src="images/certificate.png" height="250px" width="200px">
     <p class="text-center">The program provides knowledge that will help young people gain confidence in utilising technology and be productive content creators. 
     <div class="text-center">
  ...
  <div class="column2" >
    <h2>Our Curriculum</h2>
      <img src="images/portfolio.png" height="250px" width="200px">
...
<div class="text-center">
  ...
  <div class="column2" >
    <h2>Resources:</h2>
      <img src="images/team.png" height="250px" width="200px">
    <p class="text-center">Quality training resources, including student and teacher manuals, are provided for access to the schools and our partners.
<div class="text-center">
        <a href="resources" class="call_to-btn  ">
